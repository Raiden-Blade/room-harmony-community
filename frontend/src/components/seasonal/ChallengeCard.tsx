    ...
    <article className="challenge-card">
      ...
      <div className="challenge-card__body">
        ...
        <dl>
          ...
          <div><dt>{challenge.status === "ACTIVE" ? "参加中" : "掲載中"}</dt><dd>{challenge.entry_count} Coordinate</dd></div>
        </dl>
