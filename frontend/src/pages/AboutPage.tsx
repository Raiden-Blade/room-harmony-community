  ...
  return (
    <div className="page-shell about-page">
      ...
      <section className="about-grid">
        ...
        <article><span>02</span><h2>コーデと部屋画像</h2><p>36件のコーデ内容は架空です。主要15件の室内画像のみ、使用許可を得たNITORI公式Coordinate参照画像をローカル収録し、残りは自作SVGです。これは一般公開Licenseではありません。利用者が公開したREAL ROOMは別扱いの本人申告で、公式確認済みではありません。</p></article>
