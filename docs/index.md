...
- [Nitori current state](audit/nitori-current-state.md)
- [Room Harmony current state](audit/room-harmony-current-state.md)
- [Gap analysis](audit/gap-analysis.md)
...
- [Participation ladder](product/participation-ladder.md)
- [Growth loop](product/growth-loop.md)
- [Seasonal growth loop](product/seasonal-growth-loop.md)
- [Challenge semantics](product/challenge-semantics.md)
- [KPI](product/kpi.md)
